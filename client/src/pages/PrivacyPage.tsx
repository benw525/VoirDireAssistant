          ...
          <div className="prose prose-slate max-w-none space-y-8">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 text-slate-700 space-y-2">
                ...
                <li>
                  <strong>OpenAI:</strong> We use OpenAI's API to provide AI-powered analysis features including juror risk assessment, question generation, strike-for-cause analysis, and strategic recommendations. Case and juror data is transmitted to OpenAI solely for real-time processing and is <strong>not stored by OpenAI</strong> after the response is generated. We explicitly configure all API requests with zero-retention settings (<code className="text-xs bg-slate-100 px-1 py-0.5 rounded">store: false</code>) to ensure that your data is never persisted on OpenAI's servers. <strong>Your data is not used for AI model training.</strong> OpenAI's API data usage policies confirm that API data is not used to train their models. For more details, please review <a href="https://openai.com/privacy" target="_blank" rel="noopener noreferrer" className="text-amber-600 hover:text-amber-700 underline">OpenAI's Privacy Policy</a> and their <a href="https://openai.com/enterprise-privacy" target="_blank" rel="noopener noreferrer" className="text-amber-600 hover:text-amber-700 underline">API Data Privacy documentation</a>.
                </li>
              </ul>
            ...
            <section>
              ...
              <p className="text-slate-700 leading-relaxed">
                We retain your account information for as long as your account is active or as needed to provide the Service. Case and juror data is retained in our database as long as your account is active. <strong>Data sent to AI providers (OpenAI) for analysis is processed in real-time and is not retained by the AI provider after the response is generated.</strong> AI-processed data is not stored, logged, or used for any purpose beyond generating the immediate response. You may request deletion of your data at any time by contacting us. Upon account termination, we will delete or anonymize your data within 90 days, except where we are required to retain it for legal, regulatory, or legitimate business purposes.
              </p>
            </section>
