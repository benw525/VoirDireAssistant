                              ...
                              <AnimatePresence>
                                {isNoteOpen && (
                                  <motion.div
                                    ...
                                    className="absolute z-50 left-1/2 -translate-x-1/2 bottom-full mb-2 w-64 bg-white rounded-xl shadow-xl border border-blue-200 p-3"
                                  >
                                    <div className="text-[10px] font-semibold text-blue-600 mb-1.5 flex items-center justify-between">
                                      <span>
                                        <StickyNote className="w-3 h-3 inline mr-1" />
                                        Note for #{juror.number}
                                      </span>
                                      <button
                                    ...
                                    <div className="flex gap-1.5">
                                      ...
                                      <button
                                        ...
                                        className="px-2.5 py-1.5 rounded-lg bg-blue-500 text-white hover:bg-blue-600 transition-colors shrink-0"
