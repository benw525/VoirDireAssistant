...
const RAW_FLUX_KEY = process.env.FLUXPROMPT_API_KEY || process.env.FLUX_API_KEY || "";
const FLUX_API_KEY = RAW_FLUX_KEY.replace(/^FLUXPROMPT_API_KEY[._]?/i, "").replace(/^FLUX_API[._]?/i, "");
